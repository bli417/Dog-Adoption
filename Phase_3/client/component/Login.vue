...
<div class="login" id="login">
  <b-overlay :show="isLoging" rounded="sm">
    <div class="log-bg">
      ...
      <div class="log-logo">Mo's Mutt House!</div>
      <div class="log-title">CS6400 2020 Summer</div>
      <div class="log-text">@Team012</div>
    </div>
    <div class="log-error">
    ...
    <div class="log-email">
      <input type="text" placeholder="Email" :class="'log-input' + (email==''?' log-input-empty':'')" v-model="email">
...
export default {
  ...
  methods:{
      ...
      let url = `${this.$store.state.domain}login`;
...
.log-title{color: #43b1a2; font-size: 16px; text-align: center; margin: 10px auto;}
.log-text{color: #43b1a2; font-size: 13px; text-align: center; margin: 0 auto;}
...
.log-error{width: 370px;margin: auto;}
